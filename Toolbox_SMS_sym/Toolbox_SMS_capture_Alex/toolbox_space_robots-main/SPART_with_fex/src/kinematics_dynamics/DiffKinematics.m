...
%   * r0 -- Position of the base-link center-of-mass with respect to the origin of the inertial frame, projected 
%           in the inertial CCS -- [3x1].
...
%   * g -- Vector from the origin of the ith joint CCS to the origin of the ith link CCS, projected in 
%           the inertial CCS -- as a [3xn] matrix.
