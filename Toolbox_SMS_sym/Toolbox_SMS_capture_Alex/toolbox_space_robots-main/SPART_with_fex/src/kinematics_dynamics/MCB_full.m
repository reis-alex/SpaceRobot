function [M0_tilde,Mm_tilde, M0, Mm]=MCB_full(I0,Im,Bij,Bi0,robot)
...
%   * M0 -- Base-link mass composite matrix without children -- as a [6x6] matrix
%   * Mm -- Manipulator mass composite link matrix without children -- as a [6x6xn] matrix
%
...
for i=n:-1:1
    ...
    Mm(1:6,1:6,i)=Mm_tilde(1:6,1:6,i);
