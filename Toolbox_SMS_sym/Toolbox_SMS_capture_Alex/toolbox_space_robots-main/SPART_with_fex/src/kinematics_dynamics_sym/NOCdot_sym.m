function [Ndot] = NOCdot_sym(r0,t0,rL,tL,P0,pm,robot)
...
import casadi.*
%Pre-allocate NOCdot
Ndot=SX.zeros(6+6*robot.n_links_joints,6+robot.n_q);
...
for i=1:robot.n_links_joints
    [J0doti, Jmdoti]=Jacobdot_sym(rL(1:3,i),tL(1:6,i),r0,t0,rL,tL,P0,pm,i,robot);
