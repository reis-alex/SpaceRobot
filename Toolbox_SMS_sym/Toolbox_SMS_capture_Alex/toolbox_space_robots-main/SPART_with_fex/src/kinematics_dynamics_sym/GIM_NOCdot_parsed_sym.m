function [H0dot, H0mdot, Hmdot]=GIM_NOCdot_parsed_sym(N, Ndot,I0,Im,I0_d,Im_d,robot)
...
Hdot = GIM_NOCdot_sym(N, Ndot,I0,Im,I0_d,Im_d,robot);

H0dot = Hdot(1:6, 1:6);
H0mdot = Hdot(1:6, 7:6+robot.n_q);
Hmdot = Hdot(7:6+robot.n_q, 7:6+robot.n_q);
end