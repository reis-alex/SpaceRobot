function [Bij,Bi0,P0,pm]=DiffKinematics_sym(R0,r0,rL,e,g,robot)
...
for j=1:n
    for i=1:n
        if robot.con.branch(i,j)==1
            ...
            Bij{i}{j}(1:6,1:6)=[SX.eye(3), SX.zeros(3,3); SkewSym(rL(1:3,j)-rL(1:3,i)), SX.eye(3)];
        else
...
%Compute Bi0
for i=1:n
    Bi0{i}(1:6,1:6)=[SX.eye(3), SX.zeros(3,3); SkewSym(r0-rL(1:3,i)), SX.eye(3)];
end
