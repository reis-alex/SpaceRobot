function [Hdot]=GIM_NOCdot_sym(N, Ndot,I0,Im,I0_d,Im_d,robot)
...
import casadi.*
%Pre-allocate M
M=SX.zeros(6+6*robot.n_links_joints,6+6*robot.n_links_joints);
...
for i=1:robot.n_links_joints
    ...
    Mdot(6+6*i-5:6+6*i,6+6*i-5:6+6*i)=[Im_d{i},zeros(3,3);zeros(3,3),zeros(3,3)];
end
