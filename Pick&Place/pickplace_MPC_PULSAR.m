...
accel =  casadi.substitute(f_mpc,satelite.state_vars(15:20),  -H00\H0q*satelite.state_vars(21:end));
accel = casadi.substitute(accel, satelite.R0,  R);
accel = casadi.Function('accel',{satelite.state_vars([1:14 21:end]), tau},{accel});
